...
{
	[PCDEVA1X] = {.config_item1 = 21, .config_item2 = 22},
	[PCDEVB1X] = {.config_item1 = 31, .config_item2 = 32}
...
static int __init platform_driver_imx8mp_init(void)
{
	int ret;
...
static void __exit platform_driver_imx8mp_cleanup(void)
{
...
module_init(platform_driver_imx8mp_init);
module_exit(platform_driver_imx8mp_cleanup);



MODULE_LICENSE("GPL");
MODULE_AUTHOR("ankur");
MODULE_DESCRIPTION("platform driver which handles 2 platform pcdevs");
